...
class supervisor(models.Model):
    user=models.OneToOneField(User,on_delete=models.CASCADE)
    profile_pic= models.ImageField(upload_to='profile_pic/supervisorProfilePic/',null=True,blank=True)
    address = models.CharField(max_length=40)
    mobile = models.CharField(max_length=20,null=False)
...
class Request(models.Model):
    cat=(('2BHK','2BHK'),('3BHK','3BHK'),('4BHK','4BHK'),('Duplex','Duplex'))
    category=models.CharField(max_length=50,choices=cat)

    home_no=models.PositiveIntegerField(null=False)
    home_name = models.CharField(max_length=40,null=False)
    home_model = models.CharField(max_length=40,null=False)
    home_brand = models.CharField(max_length=40,null=False)
